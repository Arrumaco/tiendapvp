class Cliente::UsersController < Admin::UsersController 

  def collection #Redefinimos para aplicar filtro de cliente...
  ...
  def create #Redefinimos para asignar cliente_id...
    invoke_callbacks(:create, :before)
    @object.cliente_id = params[:cliente_id] #Actualizamos el cliente del usuario...
    if @object.save
  ...
  def update #Redefinimos para asignar cliente_id...
